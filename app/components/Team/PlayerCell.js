...
export default class PlayerCell extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            basicPlayerInfo: []
                    ...
                    <View style={styles.data}>
                        <View style={styles.playerData}>
                            <Text style={{ fontSize: 10, marginRight: 10 }}>
                                Age: {this.state.basicPlayerInfo[9]}
                            </Text>

                            <Text style={{ fontSize: 10, marginRight: 10 }}>
                                Height: {this.state.basicPlayerInfo[6]}
                            </Text>

                            <Text style={{ fontSize: 10, marginRight: 10 }}>
                                Weight: {this.state.basicPlayerInfo[7]}
                            </Text>
                        </View>
